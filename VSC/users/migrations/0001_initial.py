    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Права пользователя.', related_name='custom_user_permissions_set', to='auth.permission', verbose_name='Права')),
            ],
            options={
